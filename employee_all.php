...
<body>
    ...
    echo "<h2>Showing Details of All Employees</h2><br><br>";
             
    $q_str = "SELECT emp.emp_id, emp.fname, emp.mname, emp.lname, emp.emp_dob, emp.emp_cntct_no, emp.emp_doj, emp.emp_city, emp.emp_state, dept.dept_name FROM emp INNER JOIN dept ON emp.dept_id=dept.dept_id";
